...
func ExampleConfig_CreateFromFiles() {
	...
	// imported: []
	// initial: [hello]
	// all: [errors fmt hello internal/poll internal/race io math os reflect runtime runtime/internal/atomic runtime/internal/sys strconv sync sync/atomic syscall time unicode/utf8 unsafe]
...
func ExampleConfig_Import() {
	...
	// all: [bufio bytes errors flag fmt internal/poll internal/race io log math math/rand os reflect runtime runtime/debug runtime/internal/atomic runtime/internal/sys runtime/trace sort strconv strconv_test strings sync sync/atomic syscall testing time unicode unicode/utf8 unsafe]
